...
public class LoginLK extends BaseCase {
    ...
    public void login() {
        ...
        driver.findElement(By.xpath("//*[@id=\"app\"]/div/div/div[3]/div/p[1]/input")).sendKeys("201205000068");
        ...
        sleep();
        //点击开始答题按钮
        driver.findElement(By.xpath("//*[@id=\"wrapMain\"]/div[2]/div[1]/div/div[3]/button/span")).click();
        sleep();
